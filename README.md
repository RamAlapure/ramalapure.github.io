...
Push to **`main`** — GitHub Actions builds Astro and publishes to [alapureram.com](https://alapureram.com) automatically.

Repo settings: Pages source = **GitHub Actions** (workflow: `.github/workflows/deploy.yml`).
